...
export async function getED25519MasterKeyFromSeed(seed) {
...
export async function deriveED25519HardenedKey(parent, index) {
...
export async function deriveEd25519Path(seed, path) {
